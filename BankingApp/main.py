from BankingApp.Edges import guardrail_edge, route_transaction_tools
from BankingApp.Nodes import guardrail_node
from BankingApp.Nodes.account_agent import get_account_agent_nodes
from BankingApp.Nodes.knowledge_agent import get_knowledge_agent_nodes
from BankingApp.Nodes.transaction_agent import get_transaction_agent_nodes
...
def build_graph(all_mcp_tools, checkpointer=None):
    """
    Assembles and compiles the map-reduce banking agent.
    Pass your PostgreSQL checkpointer here to enable long-term memory.
    """
    ...
    workflow.add_conditional_edges(
        ...
        {
            # tools_condition returns "tools" if the LLM makes a tool call
            "tools": "account_tools",
            # If no tools are called, it returns END. We route that to your aggregator.
            END: "aggregator" 
        }
    )
